      ...
      */}
                    ...
                    {onDay.map((s) => (
                      ...
                      >
                        ...
                        <button
                          ...
                          className="pressable min-h-11 rounded-btn border border-border px-2 py-1 text-xs font-semibold text-foreground disabled:opacity-60"
                        >
                          Remove
                        </button>
                      </li>
      ...
      >
        ...
        <button
          ...
          className="pressable min-h-11 mt-4 rounded-btn bg-primary px-4 py-2 text-sm font-semibold text-primary-foreground disabled:opacity-60"
        >
