          ...
          {!live && plan.data?.is_offered && plan.data.price_cents !== null && (
            <>
              ...
              <button
                ...
                className="mt-4 inline-flex items-center gap-2 rounded-btn bg-primary px-4 py-2.5 font-semibold text-primary-foreground disabled:opacity-60"
              >
                {subscribe.isPending
                ...
                <div className="mt-4">
                  {confirming ? (
                    ...
                    <button
                      ...
                      disabled={renewal.isPending}
                      className="inline-flex items-center gap-2 rounded-btn border border-border bg-background px-4 py-2.5 font-semibold text-foreground disabled:opacity-60"
                    >
                      Cancel subscription
                    </button>
                  )}
