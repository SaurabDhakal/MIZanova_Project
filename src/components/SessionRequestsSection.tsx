...
import { answerBooking, fetchIncomingBookings, queryKeys } from '../lib/api'
  ...
  return (
    <section className="mt-8 rounded-card border border-border bg-card p-6 shadow-raised">
      ...
      <p className="mt-1 max-w-prose text-muted-foreground">
        ...
        it in your calendar and emails them your answer &mdash; they are told,
        so they are not left refreshing a page waiting for one.
      </p>
            ...
            {answering === b.id ? (
              <div className="mt-3">
                ...
                <div className="mt-2 flex flex-wrap gap-2">
                  <button
                    ...
                    className="pressable inline-flex min-h-11 items-center rounded-btn bg-danger-strong px-4 py-2 font-semibold text-white disabled:opacity-50"
                  >
                    Decline
                  </button>
                  <button
                    ...
                    className="pressable min-h-11 rounded-btn border border-border bg-card px-4 py-2 font-semibold text-foreground"
                  >
                    Back
                  </button>
                </div>
              ...
              <div className="mt-3 flex flex-wrap gap-2">
                <button
                  ...
                  className="pressable min-h-11 rounded-btn bg-primary px-4 py-2 font-semibold text-primary-foreground disabled:opacity-50"
                >
                  Accept
                </button>
                <button
