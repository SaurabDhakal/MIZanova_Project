  ...
  return (
    <div className="mx-auto max-w-5xl p-6 md:p-10">
      ...
      <div className="mt-3 flex flex-wrap gap-3">
        <button
          type="button"
          className="pressable min-h-11 rounded-btn bg-primary px-4 py-2.5 font-semibold text-primary-foreground hover:brightness-110"
        >
          Log behaviour
        </button>
        <button
          type="button"
          className="pressable min-h-11 rounded-btn border border-border bg-card px-4 py-2.5 font-semibold text-foreground hover:bg-background"
        >
          View details
        </button>
      </div>
