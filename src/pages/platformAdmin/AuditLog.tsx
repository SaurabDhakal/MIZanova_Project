  ...
  return (
    <div>
      <PageHeader
        ...
        actions={
          <button
            ...
            disabled={total === 0}
            className="pressable min-h-11 rounded-btn border border-border bg-card px-4 py-2.5 text-sm font-semibold text-foreground disabled:opacity-50"
          >
      ...
      <PageNote>
        ...
        staff moving school, every change to the AI controls, and — since db/064
        — schools being created or having their status changed, invoices voided,
        specialist applications decided and enquiries triaged. db/065 added
        corrections to a child&rsquo;s record, and db/066 a school correcting
        its own details. Each is written by a database trigger rather than by
        this application, so no screen can forget to record one. Who opened a
        child&rsquo;s record is a separate trail on Record Access: that is
        generated by ordinary work rather than by an administrative decision,
